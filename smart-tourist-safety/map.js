document.addEventListener('DOMContentLoaded', () => {
    ...
    const safeZones = [
        L.rectangle([[40.7, -74.1], [40.8, -74.0]], {color: "#008000", weight: 1, fillOpacity: 0.2}).addTo(map),
        L.rectangle([[51.5, -0.1], [51.6, 0.0]], {color: "#008000", weight: 1, fillOpacity: 0.2}).addTo(map)
    ];
